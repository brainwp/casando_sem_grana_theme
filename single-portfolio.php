...
<!-- <script>(function(d, s, id) {
    ...
    <div id="content">
			...
			<div class="post-wrap clearfix">
				...
				<div class="portfolio-tabs">
					...
					<ul class="pagination">
						...
						<li class="current"><a href="#1"><?php _e('O que faz?', 'engine'); ?></a></li>
					...
					<!-- /.pagination -->
                    <a href="http://casandosemgrana.com.br/fornecedores-justos/" style="position: absolute; right:0px; bottom:-33px; color:#ed1942; font-size: 16px; font: 300 16px/1.6 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif;">ver todos fornecedores</a>
				</div>
				<!-- /.portfolio-tabs -->
			</div>
			<!-- /.post-wrap -->
		...
		<?php endif; ?>
        <div class="linha_fami" style="width:642px; height:1px; background-color:#ECF0F3; margin-top:20px; margin-bottom:40px;"></div>
		<div class="fb-comments" data-href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']; ?>" data-num-posts="300" data-width="642"></div>
	</div><!-- #content -->
